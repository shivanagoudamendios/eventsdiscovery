...
- (void)selectNone {
    ...
    if (_unselectedBackgroundColor) {
        ...
        unselectedBackgroundColor = [UIColor colorWithRed:255.0f green:0.78f blue:0.8f alpha:1.0f];
    }
...
- (void)dk_controlSelect:(UIButton*)button {
    ...
    if (_selectedTextColor) {
        ...
        selectedColor = [UIColor colorWithRed:1.0f green:1.0f blue:1.0f alpha:1.0f];
    }
    ...
    if (_selectedBackgroundColor) {
        ...
        selectedBackgroundColor = [UIColor colorWithRed:255.0f green:0.75f blue:0.75f alpha:1.0f];
    }
