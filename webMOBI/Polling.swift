...
class Polling: NSObject,Mappable,NSCoding {
    ...
    var title : String? = ""
    var caption  : String? = ""
    var items  : [newPollingItems]? = [newPollingItems]()
    
    required init?(map: Map) {
        
    }
    
    init(type: String,checkvalue: String, iconCls: String,title: String,caption: String,items: [newPollingItems]) {
        self.type = type
    ...
    convenience required init?(coder aDecoder: NSCoder) {
        ...
        self.init(type: type as! String,checkvalue: checkvalue as! String, iconCls: iconCls as! String,title: title as! String,caption: caption as! String,items: items as! [newPollingItems])
    }
