...
class SocialMedia: NSObject,Mappable,NSCoding {
    ...
    var title : String? = ""
    var caption  : String? = ""
    var items  : [SocialMediaItems] = [SocialMediaItems]()
    ...
    init(type: String,checkvalue: String, iconCls: String,title: String,caption: String,items: [SocialMediaItems]) {
        self.type = type
    ...
    convenience required init?(coder aDecoder: NSCoder) {
        ...
        self.init(type: type as! String,checkvalue: checkvalue as! String, iconCls: iconCls as! String,title: title as! String,caption: caption as! String,items: items as! [SocialMediaItems])
    }
